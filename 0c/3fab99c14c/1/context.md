...
Let's disable the X button and the source selector when confirming as well
...
The source selector collapsed and displays in a broken state
...
The X button should be disabled, too
