...
Analyze the title extraction failures below. Read each failing input file
and the current implementation at lib/text-classifier/title-extractor.ts.

Write your analysis to tools/title-loop/docs/6-8a6c985/feedback.md explaining:
...
Failures:
- File: /Users/eryk.napierala/Projects/fasola/tools/title-loop/input/Baked Eggs wit...
