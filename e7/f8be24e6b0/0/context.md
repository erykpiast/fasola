...
Implement the specification at: @.simple-task-master/tasks/8-moving-the-photo-on-preview-or-on-the-edit-screen-should-allow-showing-the-very-top-of-the-photo.md
...
1. **Check Task Management**:
   ...
   - If STM shows "Not installed" → Use TodoWrite i...
