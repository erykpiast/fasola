...
/// Remap a color UIImage using float32 X and Y map arrays, preserving color channels.
/// Same as remapImage but operates on the full-color (BGR) image instead of converting to grayscale.
+ (nullable UIImage *)remapColorImage:(UIImage *)image
                                 mapX:(NSArray<NSNumber *> *)mapX
                                 mapY:(NSArray<NSNumber *> *)mapY
                                width:(NSInteger)outWidth
                               height:(NSInteger)outHeight;
